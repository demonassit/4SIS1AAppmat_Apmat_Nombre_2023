...
public class Utilidades {
    ...
    /*
    las utilidades son los elementos de la agenda o directorio
    estos elementos son las filas o columna como quieran verlo
    que deben de ser estaticas cuando se guarde el objeto de la persona
    en esta clase vamos a definir cada elemento para intercambiar datos
    */
    ...
    //variable para saber que fila estan seleccioando
